...
#define BUTTON_SAMPLES_PRESSED 5	// number of samples before a button is considered pressed
#define BUTTON_SAMPLES_RELEASED 1	// number of samples before a button is considered released
